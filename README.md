...
- 💻 I specialize in modern web development using **HTML, CSS, JavaScript**, and build backend logic with **Python & C#**.
- 🤝 I’m open to collaborating on **indie games**, **Unity tools**, or **front-end web projects**.
- 🧠 Looking to improve my skills in: game architecture, optimization, and 3D workflow pipelines.
